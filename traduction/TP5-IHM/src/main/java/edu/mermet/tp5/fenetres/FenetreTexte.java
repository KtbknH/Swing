...
public class FenetreTexte extends AbstractFenetreInterne {
	...
	public void traduire() {
		setTitle(gestionnaire.getString(Ressources.FEN_TEXTE_TITRE));
		actionGras.putValue(Action.NAME, gestionnaire.getString(Ressources.FEN_TEXTE_GRAS));
		actionRouge.putValue(Action.NAME, gestionnaire.getString(Ressources.FEN_TEXTE_ROUGE));
		style.setName(gestionnaire.getString(Ressources.FEN_TEXTE_STYLE));
	}
